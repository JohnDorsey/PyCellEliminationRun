...
def test(interpolationModesToTest=["linear", "sinusoidal", "finite_difference_cubic_hermite"], scoreModesToTest=["vertical_distance"], soundSrcStr=defaultSampleSoundSrcStr, soundLength=1024):
